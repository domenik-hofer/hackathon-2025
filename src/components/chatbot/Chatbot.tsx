...
export function Chatbot() {
    ...
    const pushUser = (text: string) => setHistory(h => [...h, { sender: 'user', text }]);

    const pushBot = (text: string) => setHistory(h => [...h, { sender: 'bot', text }]);
                ...
                <div className={c('messages')} ref={listRef}>
                    ...
                    <div className={c('message')}>
                        ...
                        <div className={c('bubble')}>
                            ...
                            <div className={c('options')}>
                                <div className={c('option')} onClick={() => handleOption('Status')}>
                                    Status
                                </div>
                                <div className={c('option')} onClick={() => handleOption('Etwas zweites')}>
                                    Etwas zweites
                                </div>
                                <div className={c('option')} onClick={() => handleOption('Etwas cooles drittes!')}>
                                    Etwas cooles drittes!
                                </div>
                            </div>
                        </div>
                    ...
                    {history.map((m, i) => (
                        <div key={i} className={c('message', m.sender === 'user' && 'user')}>
                            {m.sender === 'bot' && <div className={c('bot')}>{chatbotImg()}</div>}
